...
function innerTextInEng() {
    return [
        ...
        aboutText2 = "I have previously worked in nursing homes and as a personal assistant. During this time I have developed my collaboration skills and the ability to work under pressure.",
        langTitle = 'Languages',
        svTitle = 'Swedish',
        sv = 'Native speaker',
        enTitle = 'English',
...
function innerTextInSwe() {
    return [
        ...
        aboutText2 = 'Jag har tidigare arbetat inom vården på äldreboenden och som personlig assistent. Det har gett mig vana att samarbeta med människor och att hantera stress.',
        langTitle = 'Språk',
        svTitle = 'Svenska',
        sv = 'Modersmål',
        enTitle = 'Engelska',
